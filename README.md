...
W CMD należy przejść do folderu `.../Agrobot/main` i uruchomić komendę `uvicorn --app-dir main/python server:app --reload --host 0.0.0.0 --port 8000 --env-file ./.env`. Po załadowaniu backendu w drugim terminalu należy:
...
```shell
npm --prefix main/krus-demo install
```
